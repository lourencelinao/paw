<template>
	<div class="font-graphik">
		...
		<!-- table -->
		<div class="flex flex-col mt-5 shadow-lg">
					...
					<div class="shadow-lg overflow-hidden sm:rounded-lg">
						<table class="min-w-full">
							...
							<tbody class="bg-white">
								<tr v-for="(dog, indx) in dogs" :key="indx" :class="{ 'bg-bluegray-050': indx % 2 != 0 }">
									<td class="px-6 py-4 whitespace-nowrap">
										<div class="flex items-center">
											...
											<div class="ml-4">
												...
												<div class="text-sm text-bluegray-500">{{dog.breed}}</div>
											</div>
										</div>
									</td>
									<!-- <td class="px-6 py-4 whitespace-nowrap">
									...
									<td class="px-6 py-4 whitespace-nowrap">
										<span
											class="px-2 inline-flex text-sm leading-5 font-semibold rounded-full" :class="{ 'bg-green-100 text-green-800': dog.status === 'Healthy', 'bg-red-100 text-red-800': dog.status === 'Died in Care', 'bg-blue-100 text-blue-800': dog.status === 'Adopted', 'bg-orange-100 text-orange-800': dog.status === 'Recuperating' }"
										>
											{{dog.status}}
										</span>
									</td>
									...
									<td class="px-6 py-4 whitespace-nowrap text-right">
										...
										>
											<router-link :to="{ name: 'DogProfile', params: { id: dog.dog_id } }" class="text-bluegray-700">
